System.register(['./ApplicationException.js', './Bind.js', './ConnectionFactory.js', './DaoFactory.js', './HttpService.js', './ProxyFactory.js', './Required.js', './decorators/Debounce.js', './decorators/Controller.js', './decorators/BindEvent.js'], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_ApplicationExceptionJs) {
      ...
      for (var _key7 in _RequiredJs) {
        if (_key7 !== "default" && _key7 !== "__esModule") _exportObj7[_key7] = _RequiredJs[_key7];
      }
